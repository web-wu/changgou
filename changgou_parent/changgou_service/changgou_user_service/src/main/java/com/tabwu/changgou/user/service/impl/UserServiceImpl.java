...
import com.tabwu.changgou.user.mapper.UserMapper;
...
public class UserServiceImpl implements UserService {
    ...
    public PageResult<User> findPage(int page, int size){
        ...
        PageHelper.startPage(page,size);
        //分页查询
        Page<User> page1 = (Page<User>) userMapper.selectAll();

        return new PageResult<User>(page1.getTotal(),page1.getResult());
    }
